...
//when this list is updated than the GLYPHLIST_LEN in EncodingTable.h need to be also updated
const char * glyphlist[][2] = {
  ...
  {"zukatakana", "<30BA>"},
//113
  {"angbracketleftBig", "<ED01>"},
  {"angbracketleftBigg", "<ED03>"},
  {"angbracketleftbig", "<ED02>"},
  {"angbracketleftbigg", "<ED04>"},
  {"angbracketrightBig", "<ED06>"},
  {"angbracketrightBigg", "<ED08>"},
  {"angbracketrightbig", "<ED07>"},
  {"angbracketrightbigg", "<ED09>"},
  {"arrowbt", "<ED0A>"},
  {"arrowdblbt", "<ED0B>"},
  {"arrowdbltp", "<ED0E>"},
  {"arrowhookleft", "<21A9>"},
  ...
  {"backslashbig", "<ED14>"},
  {"backslashbigg", "<ED16>"},
  {"bracehtipdownleft", "<ED17>"},
  {"bracehtipdownright", "<ED18>"},
  {"bracehtipupleft", "<ED19>"},
  {"bracehtipupright", "<ED1A>"},
  {"braceleftBig", "<ED1B>"},
  {"braceleftBigg", "<ED1D>"},
  {"braceleftbig", "<ED1C>"},
  {"braceleftbigg", "<ED1E>"},
  ...
  {"bracerightbigg", "<ED23>"},
  {"bracketleftBig", "<ED24>"},
  {"bracketleftBigg", "<ED26>"},
  {"bracketleftbig", "<ED25>"},
  {"bracketleftbigg", "<ED27>"},
  {"bracketrightBig", "<ED28>"},
  {"bracketrightBigg", "<ED2A>"},
  {"bracketrightbig", "<ED29>"},
  {"bracketrightbigg", "<ED2B>"},
  {"ceilingleftBig", "<ED2C>"},
  {"ceilingleftBigg", "<ED2E>"},
  {"ceilingleftbig", "<ED2D>"},
  {"ceilingleftbigg", "<ED2F>"},
  {"ceilingrightBig", "<ED30>"},
  {"ceilingrightBigg", "<ED32>"},
  {"ceilingrightbig", "<ED31>"},
  {"ceilingrightbigg", "<ED33>"},
  {"circledotdisplay", "<ED34>"},
  {"circledottext", "<ED35>"},
  {"circlemultiplydisplay", "<ED36>"},
  {"circlemultiplytext", "<ED37>"},
  {"circleplusdisplay", "<ED38>"},
  {"circleplustext", "<ED39>"},
  {"contintegraldisplay", "<ED3B>"},
  {"contintegraltext", "<ED3C>"},
  {"coproductdisplay", "<ED3D>"},
  {"coproducttext", "<ED3E>"},
  {"floorleftBig", "<ED42>"},
  {"floorleftBigg", "<ED44>"},
  {"floorleftbig", "<ED43>"},
  ...
  {"hatwider", "<ED4B>"},
  {"hatwidest", "<ED4C>"},
  {"integraldisplay", "<ED4D>"},
  {"integraltext", "<ED4E>"},
  {"intersectiondisplay", "<ED4F>"},
  {"intersectiontext", "<ED50>"},
  {"logicalanddisplay", "<ED51>"},
  {"logicalandtext", "<ED52>"},
  {"logicalordisplay", "<ED53>"},
  {"logicalortext", "<ED54>"},
  {"mapsto", "<2192>"},
  {"parenleftBig", "<ED5A>"},
  {"parenleftBigg", "<ED5C>"},
...
//278
  ...
  {"Ifractur", "<2111>"},
  {"FFsmall", "<F766F766>"},
  {"FFIsmall", "<F766F766F769>"},
  {"FFLsmall", "<F766F766F76C>"},
  {"FIsmall", "<F766F769>"},
  {"FLsmall", "<F766F76C>"},
  {"Germandbls", "<00530053>"},
  {"Germandblssmall", "<F773F773>"},
  {"Ng", "<014A>"},
  {"Omega", "<2126>"},
  {"Rfractur", "<211C>"},
  {"SS", "<00530053>"},
  ...
  {"triangleleftequal", "<22B4>"},
  {"triangleleftsld", "<25C0>"},
  {"trianglerightequal", "<22B5>"},
  ...
  {"notexistential", "<2204>"},
  {"notfollows", "<2281>"},
  {"notfollowsoreql", "<2AB00338>"},
  {"notforces", "<22AE>"},
  {"notforcesextra", "<22AF>"},
  {"notgreaterdblequal", "<22670338>"},
  {"notgreaterequal", "<2271>"},
  {"notgreaterorslnteql", "<2A7E0338>"},
  {"notlessdblequal", "<22660338>"},
  {"notlessequal", "<2270>"},
  {"notlessorslnteql", "<2A7D0338>"},
  {"notprecedesoreql", "<2AAF0338>"},
  {"notsatisfies", "<22AD>"},
  {"notsimilar", "<2241>"},
  {"notsubseteql", "<2288>"},
  {"notsubsetordbleql", "<2AC50338>"},
  {"notsubsetoreql", "<228A>"},
  {"notsuperseteql", "<2289>"},
  {"notsupersetordbleql", "<2AC60338>"},
  {"notsupersetoreql", "<228B>"},
  {"nottriangeqlleft", "<22EC>"},
  {"nottriangeqlright", "<22ED>"},
